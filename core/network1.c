...
int network1_set_buffer(network1_complete *c,int bind_id,char *buffer, int buflenint force_flag;) 
{
...
static int handle_three(c,i,struct timeval thedate, int only_call_after_rounds_done) {

if (c->communicator[i]==c->participant_number) {  
  return 1;
  }
int communicator = communicator[i];
...
// maybe     c->pollfd.fd = -1;
  ...
  if (i<NUMBER_OF_NETWORK1_PARTICIPANTS) {
    ...
    if ((c->network1_get_new_send_buffer[i]||(network1_pull_next_send_buffer_from_queue[i])) {
...
ststic int process_poll_buffer_status(network1_complete *c,int cm,int compute_statistics_at_end) {
  int communicator =cm;
  int ii=receiving_poll[communicator];
  if (c->buffer[ii]) {
    if (c->buflen[ii]) {
  ...
  if (compute_statistics_at_end) {
    ...
    if (c->poll_state[oo]==4) { // if we are state 4
      c->receiveable[communicator]=1;
      }
    else {
      if (!c->recv_buffer_missing[communicator]) {
        c->receiveale[communicator]=0;
        }
      }
    } 
  ...
  int oo=sending_poll[communicator];
  if (c->buffer[oo]) {
    if (c->buflen[oo]) {
  ...
  if (compute_statistics_at_end) {
    if (c->poll_state[oo]==4)  {
      if (!send_buffer_full[communicator]) {
        c->sendable[oo]=0;
	}
      }
    else if (c->poll_state[oo]==3)  {
      if (send_buffer_missing[communicator]) {
        c->sendable[oo]=0;
	}
      }
    }  																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																										      
...
for (int i=0;i<6;i++) {
  int ii=receiving_poll[c,i,FALSE];
  }  																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																										      
return;
}																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																				      
...
int network1_poll_check(network1_complete *c,int compute_statistics_at_end) {
...
for (int i=0;i<c->NUMBER_OF_NETWORK1_PARTICIPANTS;i++) {
  c->sendable[i]=1;
  c->receiveable[i]=1;
  c->countdown=[i]=1;
  c->alive=[i]=1;
...
// maybe       c->pollfd.fd = -1;
  ...
  if (c->poll_state[i]==5) {  // this was actioned earlier, and we got past the wait time
    ...
    if (i<NUMBER_OF_NETWORK1_PARTICIPANTS) {  
      if (c->network1_get_new_receive_buffer[i]) {  // if receivers are dynamic
        c->buffer[i]=NULL; // we are done. wipe it out
	c->buflen[i]=0;
        }
  ...
  if (handle_three(x,i, c->local_poll_predo_start_time[c->network1_check_poll_runs_in_call)) {
    continue;
    }     
...
for (i=0;i<6;i++) {
  if ((c->poll_state[sending_poll[i]) >=6) {
    c->sendable[i]=0;
    } 
  if ((c->poll_state[receiving_poll[i]) >=6) {
    c->receiveable[i]=0;
    } 
  c->responsive[i] = c->sendable[i]  & c->receiveable[i];
  if ((c->poll_state[sending_poll[i]) >=7) {
    c->countdown[i]=0;
    } 
  if ((c->poll_state[receiving_poll[i]) >=7) {
    c->countdown[i]=0;
    } 
    } 
  if ((c->poll_state[sending_poll[i]) >=8) {
    c->alive[i]=0;
    } 
  if ((c->poll_state[receiving_poll[i]) >=8) {
    c->alive[i]=0;
    } 
...
process_poll_buffer_statuses(c,FALSE);  
...
// and we can use the sendable and receiveable stuff to do less.
{ // Block to handle the polls 
  for (int i=0;i<c->current_number_of_polls;i++) {
	...
	socklen_t lenn=sizeof(int);
        ...
        if (handle_three(x,i, c->local_poll_predo_start_time[c->network1_check_poll_runs_in_call],TRUE)) {
           continue;
          }     
...
// maybe       c->pollfd.fd = -1;
  ...
  if (c->poll_state[i]==5) {
    fprintf(stderr,"wipeout at oistdo 5    id %d\n",i);
    c->buflen[i]=0; // reset this. We can reuse the buffers
    c->poll_state[i]=3; // At this level, we ran the rounds
    }
#ifdef have_to_wait_so_we_get_triggers
/* cant do this, because we will miss rounds */
  if ((c->poll_state[i]==3)) {
    if (i<NUMBER_OF_NETWORK1_PARTICIPANTS) {
      network1_set_buffer_if_necessary(c,i);
      }
    else if (i<NUMBER_OF_NETWORK1_PARTICIPANTS_TIMES_2) {
      network1_ensure_send_buffers(c,i);
      }
    }
#endif
  }   

compute_sendable_receiveable(c,TRUE); 
process_poll_buffer_statuses(c,TRUE);  
